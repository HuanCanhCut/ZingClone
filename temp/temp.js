...
const app = {
    ...
    randerSlide: [{ img: './img/slider/0.webp' }, { img: './img/slider/1.webp' }, { img: './img/slider/2.webp' }, { img: './img/slider/3.jpg' }, { img: './img/slider/4.webp' }, { img: './img/slider/5.webp' }, { img: './img/slider/6.webp' }, { img: './img/slider/7.webp' }, { img: './img/slider/8.webp' }, { img: './img/slider/9.webp' }, { img: './img/slider/11.webp' }, { img: './img/slider/12.webp' }, { img: './img/slider/13.webp' }, { img: './img/slider/14.webp' }, { img: './img/slider/15.webp' }],
    listSinger: [
        {
            Singer: 'Jack',
    ...
    songs: [
        ...
        },
        {
            ...
            time: '3 ngày trước',
            pathSong: './music/vip/Into Your Arms - Witt Lowry ft. Ava Max (Lyrics + Vietsub) - TikTok ♫.mp3',
            type: 'free',
            duration: '02:07',
        },
        {
        ...
        },
        {
            ...
            singer: "K'NAAN",
            time: '2 ngày trước',
            pathSong: "./music/vip/K'NAAN - Wavin' Flag (Coca-Cola Celebration Mix).mp3",
            type: 'free',
            duration: '03:44',
        },
        {
        ...
        // -------- play list   ------------
        {
            ...
            time: '6 ngày trước',
            pathSong: './music/list-song/TÂY SƠN HÀO KIỆT (Remix) - JOMBIE X PHAN ANN (MV Hoạt Hình).mp3',
            type: 'free',
            duration: '4:22',
        },
        {
        ...
        },
        {
            ...
            singer: 'D.T',
            time: '6 ngày trước',
            pathSong: './music/list-song/LƯU LY (Rap Việt Mùa 2) - D.T - Lyrics - Tú Tú ✔.mp3',
            type: 'free',
            duration: '4:22',
        },
        {
        ...
        },
        {
            ...
            singer: 'Infinity',
            time: '6 ngày trước',
            pathSong: './music/us/Vietsub - Infinity - Jaymes Young - Nhạc Hot TikTok - Lyrics Video.mp3',
            type: 'free',
            duration: '4:22',
        },
    ],
            ...
            if (index <= currentIndex) {
                const html = _this.songs.map(function (item, index) {
                    return index <= currentIndex && index <= 22
                        ? `<li class="song-item song-item-right ${audio.play() && index == currentIndex ? 'music-color-playlist' : ''}" data-index=${index}> 
            ...
            if (item <= currentIndex) {
                const html = arr_PlayList.map(function (item) {
                    return item < currentIndex
                        ? `<li class="song-item song-item-right ${audio.play() && item == currentIndex ? 'music-color-playlist' : ''}" data-index=${item}> 
    ...
    randerslide: function () {
        const html = this.randerSlide.map((item, index) => {
            return `<img src="${item.img}" alt="" class="individual-ctn2-img
                        ${index == 0 ? 'individual-ctn2-img-first' : index == 1 ? 'individual-ctn2-img-second' : index == 2 ? 'individual-ctn2-img-third' : index == 3 ? 'individual-ctn2-img-four' : 'individual-ctn2-img-four'}">`
        })
    ...
    discover5: [
        {
            header: [{ img: './img/discover/ctn5/header/1.jpg' }, { img: './img/discover/ctn5/header/2.jpg' }, { img: './img/discover/ctn5/header/3.jpg' }],
        },
        {
            body: [{ img: './img/discover/ctn5/body/0.png' }, { img: './img/discover/ctn5/body/1.png' }, { img: './img/discover/ctn5/body/2.png' }, { img: './img/discover/ctn5/body/3.png' }, { img: './img/discover/ctn5/body/4.png' }, { img: './img/discover/ctn5/body/5.png' }, { img: './img/discover/ctn5/body/6.png' }],
        },
    ],
    ListLiveTream: [
        {
    ...
    disCover1: function () {
        const html = this.discover1.map((item, index) => {
            return `
             <div class="discover-ctn1-img 
                ${index == 0 ? 'discover-ctn1-img-first' : index == 1 ? 'discover-ctn1-img-second' : index == 2 ? 'discover-ctn1-img-third ' : 'discover-ctn1-img-four'}">
                <img src="${item.img}" alt="">
            </div>
        ...
        const html2 = this.discover1.map((item, index) => {
            return `
           <img class="img ${index == 0 ? 'discover-ctn1-mb-first' : index == 1 ? 'discover-ctn1-mb-second' : 'discover-ctn1-mb-third '}"
           " src="${item.img}" alt="">
          `
        })
        ...
        const html = this.songs.map((item, index) => {
            return `
                ...
                <h1 class="zingchart-number
                         ${index == 0 ? 'zingchart-body-no1' : index == 1 ? 'zingchart-body-no2' : index == 2 ? 'zingchart-body-no3' : ''}">${index + 1}
                 </h1>
    ...
    loadZingchartFooter: function (objects, start, end) {
        ...
        const html = this.songs.map((item, index) => {
            if (index >= start && index <= end) {
                ...
                <h1 class="zingchart-number 
                    ${index == start ? 'zingchart-body-no1' : index == start + 1 ? 'zingchart-body-no2' : index == start + 2 ? 'zingchart-body-no3' : ''}">${i++}
                </h1>
                <h1 class="zingchart-body-icon color-small"><i class="fa-solid fa-minus"></i></h1>
                <div class="zingchart-body-ctn">
